...
#
# Script generated by Vivado on Tue Dec 24 15:11:48 +0530 2024
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : tb_full_adder_4bit.sh
...
#
# Usage        : tb_full_adder_4bit.sh
#                tb_full_adder_4bit.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                tb_full_adder_4bit.sh [-reset_run]
#                tb_full_adder_4bit.sh [-reset_log]
#                tb_full_adder_4bit.sh [-help]
#
...
# script info
echo -e "tb_full_adder_4bit.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./tb_full_adder_4bit.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot tb_full_adder_4bit xil_defaultlib.tb_full_adder_4bit xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim tb_full_adder_4bit -key {Behavioral:sim_1:Functional:tb_full_adder_4bit} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb tb_full_adder_4bit.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./tb_full_adder_4bit.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: tb_full_adder_4bit.sh [-help]\n\
Usage: tb_full_adder_4bit.sh [-step]\n\
Usage: tb_full_adder_4bit.sh [-lib_map_path]\n\
Usage: tb_full_adder_4bit.sh [-reset_run]\n\
Usage: tb_full_adder_4bit.sh [-reset_log]\n\
Usage: tb_full_adder_4bit.sh [-keep_index]\n\
Usage: tb_full_adder_4bit.sh [-noclean_files]\n\n\
